...
if (getUserAgent() === UserAgent.IE) {
  ...
  if (navigator.language.includes('ko')) {
    msg = '엔젤스윙 플랫폼은 Chrome 브라우저에 최적화되어 있습니다. 사용자분들께서는 Chrome을 통해 엔젤스윙 플랫폼을 이용해주시면 감사하겠습니다.';
  } else {
    // eslint-disable-next-line max-len
    msg = '[Important notice] Angelswing\'s website is best optimized for Chrome browser. Please use Chrome to have the best experience on Angelswing.';
  }
