...
import { ContentsListESSModelItem } from './';
...
const story: StoryApi = storiesOf('Molecules|ContentsListESSModelItem', module);

const content: T.ESSModelContent = M.sampleContentFromType(T.ContentType.ESS_MODEL) as T.ESSModelContent;
...
Object.values(T.Language).map((lang) => {
  ...
  story.add(lang, () => (
    <Provider store={store}>
      <ContentsListESSModelItem content={content} />
    </Provider>
  ));
});
